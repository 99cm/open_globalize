...
module OpenGlobalize
  class Engine < Rails::Engine
    engine_name 'open_globalize'

    config.autoload_paths += %W(#{config.root}/lib)

    initializer "open_globalize.environment", before: :load_config_initializers do |app|
      OpenGlobalize::Config = OpenGlobalize::Configuration.new
    end

    initializer "open_globalize.permitted_attributes", before: :load_config_initializers do |app|
